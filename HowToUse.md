...
カーソル位置は選択モード時に移動できます。(肝心の **選択** は未実装です。)  
[v1.1.0 Beta](https://github.com/paralleltree/Ched/releases/tag/v1.1.0.0)ではイベントの削除が実装されていません。  
同じ位置にイベントを挿入することで上書きは可能ですが譜面完成後にいじることを推奨します。  
